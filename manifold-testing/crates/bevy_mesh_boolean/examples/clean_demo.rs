//! Simple demo showing all requested functionality working:
...
fn setup(
    ...
    let primary_entity = commands.spawn((
        ...
        PrimaryBooleanMesh {
            secondary_entity: Entity::PLACEHOLDER, // Will be updated after spawning secondary
        },
        PrimaryShape,
    )).id();
    ...
    let secondary_entity = commands.spawn((
        ...
        SecondaryBooleanMesh {
            primary_entity, // Will be updated after spawning secondary
        },
        SecondaryShape,
    )).id();
    ...
    // Add UI text to show instructions
    commands.spawn((
